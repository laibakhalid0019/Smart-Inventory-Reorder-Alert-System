      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center">
            <Link to="/dashboard/retailer" className="flex items-center space-x-2">
          ...
          <div className="hidden lg:flex items-center space-x-8">
            <NavigationMenu>
              <NavigationMenuList>
                <NavigationMenuItem>
                  <Link to="/dashboard/retailer" className="nav-link">
                    Dashboard
                  </Link>
                </NavigationMenuItem>
                ...
                <NavigationMenuItem>
                  <Link to="/retailer/requests" className="nav-link">
                ...
                <div className="flex flex-col h-full">
                  ...
                  <div className="flex flex-col space-y-4">
                    <Link 
                      ...
                      className="text-left py-3 px-4 rounded-lg hover:bg-accent/20 transition-colors text-lg font-medium"
                    ...
                    <div className="space-y-2">
                      <h4 className="text-sm font-medium text-muted-foreground px-4">Stock Management</h4>
                      <Link 
                        to="/retailer/stock/display" 
                        className="flex items-center py-2 px-4 rounded-lg hover:bg-accent/20 transition-colors"
                        onClick={() => setIsMobileOpen(false)}
                      >
